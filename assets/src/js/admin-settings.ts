...
document.addEventListener( 'DOMContentLoaded', () => {
	const checkboxKeepDays: HTMLInputElement | null =
		document.querySelector( '.pulse-keep-days' );
	const checkboxKeepForever: HTMLInputElement | null = document.querySelector(
		'.pulse-keep-forever'
	);
	...
	const resetDatabaseButton = document.querySelector( '#reset_all_pulses' );
